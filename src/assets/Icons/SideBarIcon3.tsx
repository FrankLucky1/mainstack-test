...
const SideBarIcon3 = ({ className }: Props) => {
  return (
    <span className="group hover:bg-[#EFF1F6] rounded-full h-10 w-10 flex items-center justify-center">
      ...
      >
        <path
          ...
          fill="url(#paint0_linear_21256_1459)"
        />
        <path
          ...
          fill="url(#paint1_linear_21256_1459)"
        />
        <path
          ...
          fill="url(#paint2_linear_21256_1459)"
        />
        <defs>
          <linearGradient
            id="paint0_linear_21256_1459"
            x1="4.27548"
            y1="7.14244"
            x2="15.8365"
            y2="7.14244"
