...
const SideBarIcon1 = ({ className }: Props) => {
  return (
    <span className="group hover:bg-[#EFF1F6] rounded-full h-10 w-10 flex items-center justify-center">
      ...
      >
        <path
          ...
          stroke="url(#paint0_linear_21256_1448)"
          strokeWidth="2.7"
          strokeMiterlimit="10"
        />
        <path
          ...
          stroke="url(#paint1_linear_21256_1448)"
          strokeWidth="2.7"
          strokeMiterlimit="10"
        />
        <path
          ...
          fill="url(#paint2_linear_21256_1448)"
        />
        <defs>
          <linearGradient
            id="paint0_linear_21256_1448"
            x1="2.89818"
            y1="8.44539"
            x2="18.1055"
            y2="8.44539"
