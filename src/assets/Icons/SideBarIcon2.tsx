...
const SideBarIcon2 = ({ className }: Props) => {
  return (
    <span className="group hover:bg-[#EFF1F6] rounded-full h-10 w-10 flex items-center justify-center">
      ...
      >
        <path
          ...
          fill="url(#paint0_linear_21256_1453)"
        />
        <path
          ...
          fill="url(#paint1_linear_21256_1453)"
        />
        <path
          ...
          fill="url(#paint2_linear_21256_1453)"
        />
        <defs>
          <linearGradient
            id="paint0_linear_21256_1453"
            x1="4.34182"
            y1="14.4112"
            x2="19.6375"
            y2="14.4112"
