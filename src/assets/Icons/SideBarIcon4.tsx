...
const SideBarIcon4 = ({ className }: Props) => {
  return (
    <span className="group hover:bg-[#EFF1F6] rounded-full h-10 w-10 flex items-center justify-center">
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
      ...
      >
        <path
          ...
          fill="url(#paint0_linear_21256_1465)"
        />
        <path
          ...
          fill="url(#paint1_linear_21256_1465)"
        />
        <path
          ...
          fill="url(#paint2_linear_21256_1465)"
        />
        <defs>
          <linearGradient
            id="paint0_linear_21256_1465"
            x1="8.2422"
            y1="13.8522"
            x2="20.5182"
            y2="13.8522"
